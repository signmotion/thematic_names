...
- Clone the forked repository to your local development machine
  (e.g. `git clone git@github.com:<YOUR_GITHUB_USER>/thematic_names.git`).
...
Go to the [pull request page of ThematicUniqueNameGenerator][PRs] and in the top
...
[GitHub issue]: https://github.com/signmotion/thematic_names/issues/new
[GitHub issues]: https://github.com/signmotion/thematic_names/issues
[PRs]: https://github.com/signmotion/thematic_names/pulls
